...
module.exports = (app) => {
  ...
  app.get('/api/games/bundesliga', async (req, res) => {
    const games = await Game.find({sport_key: "soccer_germany_bundesliga"})
    res.send(games)
  });

  app.get('/api/games/serie_a', async (req, res) => {
    const games = await Game.find({sport_key: "soccer_italy_serie_a"})
    res.send(games)
  });

  app.get('/api/games/liga', async (req, res) => {
    const games = await Game.find({sport_key: "soccer_spain_la_liga"})
    res.send(games)
  });
  ...
  app.get('/api/fetch/games/soccer_italy_serie_a', async (req, res) => { 

    try {
      const fetchGames = await axios({
        method: 'get',
        url: `https://api.the-odds-api.com/v4/sports/soccer_italy_serie_a/odds/?apiKey=${keys.oddsApi}&regions=eu`
      });
  ...
  app.get('/api/fetch/games/soccer_germany_bundesliga', async (req, res) => { 

    try {
      const fetchGames = await axios({
        method: 'get',
        url: `https://api.the-odds-api.com/v4/sports/soccer_germany_bundesliga/odds/?apiKey=${keys.oddsApi}&regions=eu`
      });
  ...
  app.get('/api/fetch/games/soccer_spain_la_liga', async (req, res) => { 
